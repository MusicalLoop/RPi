...
unicorn.rotation(90) # tested on pHAT/HAT with rotation 0, 90, 180 & 270
...
def blues_and_twos(x, y, step):
    ...
    #return (r * 255, (b + g) * 255, (g * 255) * 2)
    return (r * 255, (g * 255) * 2, (b + g) * 255)
    #return (r * 255, (g * 255) * 2, r * 255)

# rainbow search spotlights
def rainbow_search(x, y, step):
    #print("Rainbox Search")
